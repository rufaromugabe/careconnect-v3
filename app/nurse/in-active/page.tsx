    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative">
      ...
      <Card className="w-full max-w-md relative backdrop-blur-sm bg-white/90">
        <CardHeader>
          ...
          <CardTitle className="text-center">Account Temporarily Deactivated</CardTitle>
        ...
        <CardContent className="space-y-4">
          <div className="text-center text-sm text-muted-foreground">
            ...
            <p className="mt-4">If you believe this is an error, please contact our support team for assistance.</p>
          </div>
